...
INSTALL = /home/mpaton/spec98/999.gcc/gcc2722/1/install.sh -c
...
target=m88k-dg-dguxbcs
xmake_file=x-linux
tmake_file=m88k/t-dgux-gas
out_file=m88k.c
#out_file=./config/m88k/m88k.c
md_file=./config/m88k/m88k.md
tm_file=./config/m88k/dguxbcs.h
build_xm_file=./config/i386/xm-linux.h
host_xm_file=./config/i386/xm-linux.h
...
ALL_CFLAGS = $(X_CFLAGS) $(T_CFLAGS) $(CFLAGS) $(XCFLAGS)
...
OBJS = c-parse.o c-lang.o c-lex.o c-pragma.o \
 ...
 insn-attrtab.o m88k.o getpwd.o convert.o bc-emit.o bc-optab.o
...
c-parse.o : c-parse.c $(CONFIG_H) $(TREE_H) c-lex.h \
	...
	$(CC) -c $(ALL_CFLAGS) $(ALL_CPPFLAGS) $(INCLUDES) c-parse.c
...
gcc.o: gcc.c $(CONFIG_H) multilib.h
# MJP gcc.o: gcc.c $(CONFIG_H) multilib.h $(lang_specs_files)
	$(CC) $(ALL_CFLAGS) $(ALL_CPPFLAGS) $(INCLUDES) \
...
toplev.o : toplev.c $(CONFIG_H) $(TREE_H) $(RTL_H) bytecode.h bc-emit.h \
   flags.h input.h insn-attr.h xcoffout.h defaults.h output.h
	$(CC) -c $(ALL_CFLAGS) $(ALL_CPPFLAGS) $(INCLUDES) toplev.c
...
m88k.o: $(out_file) $(CONFIG_H) $(TREE_H) \
...
insn-output.o : insn-output.c $(CONFIG_H) $(RTL_H) regs.h real.h conditions.h \
    ...
    insn-codes.h
	$(CC) -c $(ALL_CFLAGS) $(ALL_CPPFLAGS) $(INCLUDES) insn-output.c
